        ...
        return (
            <div className="shadow-md py-2">
                <div className="flex flex-row justify-around items-center">
                    <div className="flex gap-2 items-center">{resultsBlock}</div>

                    <div className="flex flex-col gap-1">{genderBlock}</div>

                    <div className="flex flex-col gap-1 w-1/4">{ageBlock}</div>

                    <div className="flex flex-col items-center gap-1">
                        {withPhotoBlock}
                    </div>

                    <div className="w-1/4 flex flex-col gap-1">{orderBlock}</div>
                </div>
            </div>
        );
    }
