...
const Filters = () => {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between px-4 py-2 shadow-md md:hidden">
        <div className="text-sm font-semibold text-secondary">
          Results: {isPending ? <Spinner size="sm" color="secondary" /> : totalCount}
        </div>

        <Button size="sm" color="secondary" variant="bordered" onPress={() => setIsModalOpen(true)}>
          Filters
        </Button>
      </div>
