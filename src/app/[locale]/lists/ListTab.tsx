...
import MemberCard from '@/app/[locale]/members/MemberCard';
...
const ListTab = ({ members, likeIds }: Props) => {
  ...
  const translation = useTranslations('Lists');
  ...
  const tabs = [
    { id: 'source', label: `${translation('source')}:` },
    { id: 'target', label: `${translation('target')}` },
    { id: 'mutual', label: `${translation('mutual')}` },
  ];
